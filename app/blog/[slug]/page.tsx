        ...
        <article className="max-w-4xl mx-auto px-4 py-12">
          ...
          <div className="mt-12 pt-8 border-t border-gray-200">
            ...
            <div className="flex gap-4">
              {/* X (Twitter) */}
              <a
                href={`https://twitter.com/intent/tweet?url=${encodeURIComponent(shareUrl)}&text=${encodeURIComponent(attributes.title)}`}
                target="_blank"
              ...
              {/* LinkedIn */}
              <a
                href={`https://www.linkedin.com/shareArticle?mini=true&url=${encodeURIComponent(shareUrl)}&title=${encodeURIComponent(attributes.title)}`}
                target="_blank"
                rel="noopener noreferrer"
